...
const Footer = () => {
  return (
    <footer className="py-28 bg-[#f2f2f2]">
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-4">
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <p className="text-dark2">
              ...
              provident nemo iste illo quae, voluptatibus inventore blanditiis,
              voluptas veritatis ducimus rem exercitationem? Dolorum pariatur
              mollitia vel id eum dolore at!
            </p>
          </div>
          {/* second section */}
          ...
          <div className="space-y-4 max-w-[300px]">
            ...
            <div className="flex items-center">
              ...
              />
              <button className="btn-primary  text-white font-semibold py-4 px-6 rounded-e-xl">
                Go
              </button>
            </div>
            {/* social icon  */}
            <div className="flex space-x-6 py-3">
              ...
              <a href="#">
                <FaTwitter className="text-2xl  cursor-pointer hover:text-primary hover:scale-105 duration-200" />
              </a>
              <a href="#">
